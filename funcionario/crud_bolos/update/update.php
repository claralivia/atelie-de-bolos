            ...
            <div class="row justify-content-center">
                <form onsubmit="verificar()" class="col-sm-10 col-md-8 col-lg-6" enctype="multipart/form-data" id="update">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" <?echo "value = '$titulo'";?> class="form-control" autofocus name="titulo" id="titulo" placeholder=" ">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" <?echo "value = '$valor'";?> class="form-control" id="valor" placeholder="Valor" name="valor" aria-label="Quantia">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" <?echo "value = '$fatias'";?> class="form-control" id="fatias" name="fatias" placeholder="Quantidade de fatias" aria-label="Fatias" aria-describedby="basic-addon2">
                        <div class="input-group-append">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        style="height: 200px;"><?echo "$descricao";?></textarea>
                    ...
                    <?php
                        if($categoria == "Aniversário"){
                            ...
                            echo        '<option value="Aniversário" selected>Aniversário</option>';
                            ...
                            echo        '<option value="Vulcão" selected>Vulcão</option>';
                            echo        '<option value="Bolo de Pote">Bolo de Pote</option>';
                            echo        '<option value="Cupcake">Cupcake</option>';
                            echo        '<option value="Confeitado">Confeitado</option>';
                            echo    '</select>';
                            ...
                            echo        '<option value="Aniversário">Aniversário</option>';
                            echo        '<option value="Vulcão">Vulcão</option>';
                            echo        '<option value="Bolo de Pote" selected>Bolo de Pote</option>';
                            echo        '<option value="Cupcake">Cupcake</option>';
                            echo        '<option value="Confeitado">Confeitado</option>';
                            echo    '</select>';
                        }
                            ...
                            echo        '<option value="Vulcão">Vulcão</option>';
                            echo        '<option value="Bolo de Pote">Bolo de Pote</option>';
                            echo        '<option value="Cupcake" selected>Cupcake</option>';
                            echo        '<option value="Confeitado">Confeitado</option>';
                            echo    '</select>';
                        }
                            ...
                            echo        '<option value="Bolo de Pote">Bolo de Pote</option>';
                            echo        '<option value="Cupcake">Cupcake</option>';
                            echo        '<option value="Confeitado" selected>Confeitado</option>';
                            echo    '</select>';
                        }
                    ?>
